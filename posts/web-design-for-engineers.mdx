...
security, etc.) are what intimidate non-technical folks. This post will teach 
you everything you need to know to build and publish a website, so you can feel
empowered to do this on your own - even without any technical knowledge.  
...
web development practices, we have become accustomed to websites loading 
nearly instantaneously. In fact, 40% of your users will leave your website if 
it takes longer than 3 seconds to load. Hence, each page of your website should
load in **2.5 seconds or less.**  
...
surprising then that nearly 50% of your users will come from their phones.
...
<Callout>
  Pro Tip: No-code website builders like Squarespace and Wix have buttons 
  that enable you to view your site on smaller screen sizes.  
</Callout>

<Callout>
  Pro Tip: No-code website builders like Squarespace and Wix offer website 
...
Studies show that 40% of new users immediately look at a website's
navigation menu. Hence, your website's navigation menu should be easy to find
and structured in an intuitive way. It should take new users no more than 10
seconds to find what they're looking for on your website.  
...
that the data sent between your site and your users is encrypted. When your site 
uses HTTPS, users will be able to access your site on a URL 
that starts with `https://`, such as `https://yourdomain.com` or 
`https://www.yourdomain.com`. Without HTTPS, users will only be able to access 
your site from URLs that start with `http://`.  
...
<Callout>
  Pro Tip: No-code website builders like Squarespace and Wix enable HTTPS
  automatially. 
</Callout>

<Callout>
  Pro Tip: Even if HTTPS is enabled for your site, users may still be able to
